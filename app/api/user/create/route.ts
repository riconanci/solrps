...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`🎮 Creating wallet user: ${walletAddress}`);
    ...
    if (existingUser) {
      console.log(`✅ Wallet user already exists: ${walletAddress}`);
    ...
    const newUser = await prisma.user.create({
      data: {
        ...
        mockBalance: 500000, // Starting balance for new users (matches your schema default)
    ...
    console.log(`✅ Created wallet user:`, {
      id: newUser.id,
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('❌ Error batch creating wallet users:', error);
    return NextResponse.json({
      success: false,
